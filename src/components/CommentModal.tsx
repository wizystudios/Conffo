    ...
    <div className="fixed inset-0 z-50 bg-background flex flex-col">
      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="flex items-center justify-between px-3 py-2">
          ...
          <h1 className="text-sm font-semibold">Comments</h1>
          <div className="w-7" />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto pb-20">
        {isLoading ? (
          <div className="p-6 text-center">
            <div className="h-3 w-3 border-2 border-primary border-t-transparent rounded-full animate-spin mx-auto"></div>
          </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-background border-t border-border p-3">
          ...
          <form onSubmit={handleSubmit} className="flex gap-2 items-end">
            <Textarea
              ...
              rows={1}
            />
            <Button type="submit" disabled={!newComment.trim() || isSubmitting} size="sm" className="h-8">
